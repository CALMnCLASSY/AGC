        ...
        <div className="min-h-screen bg-charcoal-900 text-white flex">
            ...
            <aside className="w-64 border-r border-charcoal-700 p-6 hidden md:block">
                ...
                <nav className="space-y-4 text-sm text-gray-400">
                    <a href="/admin" className="block text-white font-bold hover:text-gold-500 transition-colors">Dashboard</a>
                    <a href="/admin/marketing" className="block hover:text-white transition-colors">Marketing</a>
                    <div>New Post</div>
                    <div>Inquiries</div>
                    <div>Settings</div>
                </nav>
